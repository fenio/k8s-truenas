...
So to see actual value files used to deploy democratic-csi on my cluster take a look at my [repo](https://github.com/fenio/homelab/tree/main/cluster/apps/disk/democratic-csi).
